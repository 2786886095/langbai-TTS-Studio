...
import {
  ...
  HardDrive, ListRestart, LoaderCircle, Monitor, Pause, Play, RefreshCw, RotateCcw,
...
export function EngineManager({ onBack, density, onDensityChange }: { onBack: () => void; density: "comfortable" | "compact"; onDensityChange: () => void }) {
  ...
  const applyZoom = async (value: number) => { setZoom(value); await window.langbaiDesktop?.setZoomFactor?.(value / 100); };
